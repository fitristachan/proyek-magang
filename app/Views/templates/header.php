        ...
        >
          ...
          <div class="z-10 flex flex-col flex-1">
            ...
            <nav class="flex flex-col flex-1 w-64 p-4 mt-4">
              ...
              <a href="/spk" class="flex items-center space-x-4 mt-4">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
              </svg>
                <span>Decision</span>
              </a>
              <a href="/spk/history" class="flex items-center space-x-4 mt-4">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    ...
    <div class="relative flex h-16 visible">
      <div class="absolute inset-y-0 left-5 flex items-center visible">
        ...
        <div class="p-2 text-violet-900 dark:text-white top-4 right-16">
          ...
          <?php } ?>
          <a href="/spk" class="text-lg no-underline text-violet-900 hover:text-violet-500 ml-3">Decision</a>
          <a href="/spk/history" class="text-lg no-underline text-violet-900 hover:text-violet-500 ml-3">History</a>
        </div>
