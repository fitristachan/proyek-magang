                    ...
                    <div class="w-full inline-flex border">
                     <div class="pt-2 w-2/12 bg-gray-100">
                        ...
                        <input
                            ...
                            id="nim"
                            class="w-10/12 focus:outline-none focus:text-black p-2"
                            value="<?= !empty($request->getPost('nim')) ? $request->getPost('nim') : '' ?>" 
            ...
            <div class="md:w-2/3 mx-auto max-w-sm space-y-5">
              <div>
                ...
                <div class="w-full inline-flex border">
                  ...
                  <select class="w-10/12 focus:outline-none focus:text-black p-2"  name="id" id="id" required>
                  <option value="" hidden>--Choose User Role--</option>
              ...
              <div>
                ...
                <div class="w-full inline-flex border">
                  ...
                  <input
                    ...
                    id="password"
                    class="w-10/12 focus:outline-none focus:text-black p-2"
                    value="<?= !empty($request->getPost('password')) ? $request->getPost('password') : '' ?>" 
              ...
              <div>
                ...
                <div class="w-full inline-flex border">
                  ...
                  <input
                    ...
                    id="confirm_password"
                    class="w-10/12 focus:outline-none focus:text-black p-2"
                    value="<?= !empty($request->getPost('confirm_password')) ? $request->getPost('confirm_password') : '' ?>" 
                    placeholder="Password" 
                    required="required"
                  />
                </div>
